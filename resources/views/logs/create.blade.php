...
@section('page-title', 'Add Time Log')
@section('page-subtitle', 'Create a new employee time record')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h2 class="text-base font-semibold text-gray-800">New Time Log</h2>
        </div>
        ...
        <form method="POST" action="{{ route('logs.store') }}">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="time" name="clock_in" value="{{ old('clock_in') }}" required
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
